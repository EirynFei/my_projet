...
public class UserRepositoryCustomImpl implements UserRepositoryCustom {
    ...
    public List<User> search(String firstName, String lastName, String email) {
        ...
        // firstName predicate
        Predicate firstNamePredicate = cb.like(user.get(UserAttribute.FIRST_NAME), "%" + firstName + "%");
        
        // lastName predicate
        Predicate lastNamePredicate = cb.like(user.get(UserAttribute.LAST_NAME), "%" + lastName + "%");
        
        // email predicate
        Predicate emailPredicate = cb.equal(user.get(UserAttribute.EMAIL), email);
